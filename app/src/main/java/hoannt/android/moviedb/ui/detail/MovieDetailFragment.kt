...
//        })
    ...
    private fun setUpCastList(view: View) {
    ...
    private fun setUpCrewList(view: View) {
        view.list_crew_movie.layoutManager = LinearLayoutManager(
            requireActivity(),
            LinearLayoutManager.HORIZONTAL, false
        )
        view.list_cast_movie.adapter = crewListAdapter
    }

    private fun setUpSimilarMoviesList(view: View) {
